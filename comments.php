                    ...
                    <div class="col-md-12 col-lg-12">													
                      ...
                      <div id="respond" class="col-lg-12 col-md-12">
                        ...
                        <form id="commentform" name="commentform" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
						  ...
						  <?php $current_user = wp_get_current_user(); echo get_avatar( $current_user->user_email, 60,'','',array('class'=>array('shadow'))); ?> 
						   <div class="name ps-3">
						  ...
						  <div class="author align-items-center mb-2">
						  <?php echo get_avatar( $comment_author_email, 60,'','',array('class'=>array('shadow'))); ?> 
						   <div class="name ps-3">
						...
						//]]>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12 mx-auto clearfix text-center">
                              ...
                              <button class="btn bg-gradient-dark btn-comment" name="submit" type="submit" id="submit" tabindex="5">发送评论</button>
							  </div>
                          </div>
                          </form>
                      </div>						
