    ...
    <form role="search" id="searchform" method="get" action="<?php echo home_url( '/' ) ?>">
        <div class="search_form_inner">
            <div class="search-bar">
                ...
                <input type="search" name="s" value="<?php echo htmlspecialchars($s) ?>" placeholder="輸入搜尋關鍵字..." />
            </div>
        </div>
    </form>
</div>
    ...
    <nav class="floating-menu-items">
        <ul>
            <?php if(get_boxmoe('blog_layout') == 'two' ){?>
                <li class="d-lg-none">
                    <a class="button" title="開啟側欄" data-bs-toggle="offcanvas" href="#blog-sidebar" aria-controls="blog-sidebar">
                        <i class="fa fa-outdent"></i>
                    </a>
                </li>
            <?php } ?>
            <?php if (get_boxmoe('lolijump') ){?>
                <li>
                    <a id="lolijump" href="#">
                        <img src="<?php echo boxmoe_themes_dir(); ?>/assets/images/top/<?php echo get_boxmoe('lolijumpsister'); ?>.gif">
                    </a>
                </li>
            <?php } ?>
        </ul>
