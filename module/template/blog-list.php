...
?>
              <article class="post-list list-one row boxmoe-bg <?php echo boxmoe_border()?>">
                ...
                <div class="post-list-content col-lg-7 col-xl-7 col-md-12 col-12">
                  <div class="category">
                    <div class="tags"><?php $category = get_the_category();if($category[0]){ echo '
                  ...
                  <div class="mt-2 mb-2">
                    <h3 class="post-title h4">
                      <a <?php echo _post_target_blank() ?> href="<?php echo get_permalink() ?>" title="<?php echo get_the_title().get_the_subtitle(false).boxmoe_connector().get_bloginfo('name')?>" class="text-reset"><?php echo get_the_title().get_the_subtitle() ?></a></h3>
                    <p class="post-content"><?php echo _get_excerpt() ?></p></div>
                    <div class="post-meta align-items-center">
                    <div class="post-list-avatar">
                    <?php echo get_avatar(get_the_author_meta('ID'),60); ?></div> 
